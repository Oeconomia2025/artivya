  ...
  return (
    <>
      ...
      >
        <div
          ...
          style={{
            ...
            borderColor: "rgba(138, 136, 246, 0.5)",
      ...
      >
        ...
        <div
          className={`w-9 h-full shrink-0 cursor-pointer relative transition-colors duration-300 ${
            expanded
              ? "bg-gradient-to-b from-[#8a88f6] via-[#11c4fe] to-[#8a88f6]"
              : "bg-gradient-to-b from-[#8a88f6]/30 via-[#11c4fe]/20 to-[#8a88f6]/30 hover:from-[#8a88f6]/50 hover:via-[#11c4fe]/40 hover:to-[#8a88f6]/50"
          }`}
          style={{ borderLeft: "1px solid rgba(138, 136, 246, 0.3)" }}
            ...
            >
              <img
                ...
                className={`w-12 h-12 rounded-full object-cover transition-all duration-200 ${
                  hoveredItem === item.name ? "scale-110 ring-2 ring-[#11c4fe]/60" : "hover:scale-110"
                }`}
              />
            </a>
          ))}
