...
const mockNFTs = [
  ...
  },
  {
    ...
    timeRemaining: null,
    properties: [
      { trait: "Atmosphere", value: "Midnight Rain", rarity: 6 },
      { trait: "Neon Color", value: "Hot Pink", rarity: 9 },
      { trait: "District", value: "Sector 7", rarity: 4 }
    ]
  },
  {
    id: 82,
    ...
    timeRemaining: "5h 12m",
    properties: [
      { trait: "Depth", value: "Abyssal", rarity: 3 },
      { trait: "Tentacles", value: "Bioluminescent", rarity: 5 },
      { trait: "Eye", value: "Ancient Gold", rarity: 2 }
    ]
  },
  {
    id: 83,
    ...
    timeRemaining: null,
    properties: [
      { trait: "Season", value: "Winter Solstice", rarity: 12 },
      { trait: "Stone", value: "Moonstone", rarity: 8 },
      { trait: "Water", value: "Still Mirror", rarity: 14 }
    ]
  },
  {
    id: 84,
    ...
    timeRemaining: null,
    properties: [
      { trait: "Armor", value: "Titanium Alloy", rarity: 4 },
      { trait: "Weapon", value: "Plasma Cannon", rarity: 3 },
      { trait: "AI Core", value: "Sentinel Class", rarity: 2 }
    ]
  },
  {
    id: 85,
    ...
    timeRemaining: null,
    properties: [
      { trait: "Frequency", value: "432 Hz", rarity: 7 },
      { trait: "Waveform", value: "Fractal", rarity: 5 },
      { trait: "Resonance", value: "Harmonic", rarity: 10 }
    ]
  },
  {
    id: 86,
    ...
    properties: [
      { trait: "Authority", value: "Council Tier", rarity: 6 },
      { trait: "Seal", value: "Arcane Script", rarity: 4 },
      { trait: "Power", value: "Triple Vote", rarity: 3 }
    ]
  },
  {
    id: 87,
    ...
    timeRemaining: null,
    properties: [
      { trait: "Origin", value: "Big Bang Fragment", rarity: 1 },
      { trait: "Energy", value: "Dark Matter", rarity: 1 },
      { trait: "Form", value: "Ever-shifting", rarity: 2 }
    ]
  },
  {
    id: 88,
    ...
    timeRemaining: null,
    properties: [
      { trait: "Sprite", value: "16-bit", rarity: 15 },
      { trait: "Weapon", value: "Holy Sword", rarity: 8 },
      { trait: "Shield", value: "Mirror Guard", rarity: 11 }
    ]
  },
  {
    id: 89,
    ...
    properties: [
      { trait: "Dimension", value: "Eleventh", rarity: 2 },
      { trait: "Aura", value: "Antimatter", rarity: 3 },
      { trait: "Form", value: "Shifting Shadow", rarity: 4 }
    ]
  }
];
...
const collections = [
  ...
  { name: "DAO Emblems", count: 3 },
  { name: "Retro Punks", count: 1 },
  { name: "Sound Waves", count: 5 },
